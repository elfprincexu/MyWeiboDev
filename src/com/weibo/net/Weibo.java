    ...
    private void startDialogAuth(Activity activity, String[] permissions) {
        ...
        dialog(activity, params, new WeiboDialogListener() {
            public void onComplete(Bundle values) {
                ...
                if (isSessionValid()) {
                    Log.d("Weibo-authorize", "Login Success! access_token=" + mAccessToken.getToken() + " expires="+ mAccessToken.getExpiresIn()); mAuthDialogListener.onComplete(values);
                } else {
...
//    }
    ...
    public void dialog(Context context, WeiboParameters parameters, final WeiboDialogListener listener) {
        ...
        if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
            ...
            WeiboDialog webdialog = new WeiboDialog(this, context, url, listener);
            webdialog.show();
        }
    }
    ...
    public boolean isSessionValid() {
        ...
        if (mAccessToken != null) {
            boolean isvalide = (!TextUtils.isEmpty(mAccessToken.getToken()) && (mAccessToken.getExpiresIn() == 0 || (System.currentTimeMillis() < mAccessToken.getExpiresIn())));
           return isvalide;
        }
        return false;
    }
